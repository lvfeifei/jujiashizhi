        ...
        <div class="content">
            <div class="xcx-head">
                <div style="display: flex">
                    <el-input class="font14" placeholder="类目名称搜索" v-model="key" clearable></el-input>
                    <el-button class="hollow_out mar_L_10" @click="search()" plain>确认</el-button>
                </div>
                <span class="xcx-add left font14" @click="add()">新增类目</span>
            </div>
            <div class="xcx-content">
                <!--列表-->
                <el-table border :data="tableData" stripe style="width: 100%">
                    <el-table-column prop="name" label="类目名称"></el-table-column>
                    <el-table-column prop="goods_num" label="包含助具数量"></el-table-column>
                    <el-table-column prop="create_time" label="添加类目时间"></el-table-column>
...
<script type="text/javascript" src="../../../static/js/aid/category_manage.js"></script>

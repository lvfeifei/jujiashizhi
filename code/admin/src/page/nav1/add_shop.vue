    ...
    <div id="add_shop">
        <el-col :span="24" class="warp-breadcrum">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item :to="{path:'/banner/swiper'}">
                    <b>商品管理</b>
                </el-breadcrumb-item>
            ...
            <div class="content">
                ...
                <div id="list">
                    <el-table border :data="class_table" style="width: 100%" class="mar_B_30">
                        <el-table-column fixed prop="name" label="规格值"></el-table-column>
                        ...
                        <el-table-column label="操作">
                            <template slot-scope="scope">
                                <el-button @click="edit(scope.$index)" type="text" size="small">修改</el-button>
                                <el-button
                ...
                <div class="rebate">
                    <el-form ref="form" class="mar_T_30" label-width="80px">
                        <el-form-item label="轮播图：" class="line_H">
                            ...
                            >在商品详情页顶部显示，请上传1-10张,尺寸750*750。</p>
                        </el-form-item>
        ...
        <div class="footer">
            <span class="prompt">
                <i class="el-icon-warning" style="color: #e6a23c;"></i>&nbsp;提交前请仔细检查各项信息！
            </span>
            <div class="butn">
                <el-button size="mini" @click="cancel">放弃编辑</el-button>
                <el-button size="mini" class="last" @click="addData">提交</el-button>
            </div>
        </div>
        ...
        >
            <el-form rel="add_spec" class="demo-ruleForm" label-width="80px">
        ...
        >
            <el-form class="demo-ruleForm" label-width="80px">
                ...
                <el-form-item class="dialog-footer">
                    ...
                    <el-button type="primary" @click="confirm2">确认修改</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
    </div>
...
<script type="text/javascript" src="../../../static/js/add_shop.js">
</script>

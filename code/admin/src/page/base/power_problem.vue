    ...
    <div id="subpage">
        <el-col :span="24" class="warp-breadcrum">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>能力问题</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
        <div class="content">
            <div class="xcx-head">
            ...
            <div class="xcx-content">
                ...
                <el-table border :data="tableData" stripe style="width: 100%">
                    ...
                    <el-table-column prop="show" label="选项展示"></el-table-column>
                    <el-table-column prop="rela" label="已关联标签"></el-table-column>
...
<script type="text/javascript" src="../../../static/js/base/power_problem.js"></script>

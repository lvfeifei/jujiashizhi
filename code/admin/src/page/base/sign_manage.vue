        ...
        <div class="content">
            <div class="xcx-head">
                <div style="display: flex">
                    <el-input class="font14" style="width:240px;" placeholder="按标签名称搜索" v-model="key" clearable></el-input>
                    <el-button class="hollow_out mar_L_10" @click="search()" plain>确认</el-button>
                </div>
                <span class="xcx-add left font14" @click="add()">新增标签</span>
            </div>
...
<script type="text/javascript" src="../../../static/js/base/sign_manage.js"></script>

        ...
        <div class="content">
            <div class="xcx-head">
                <div style="display: flex">
                    <el-input class="font14" placeholder="输入文章标题" v-model="key" clearable></el-input>
                    <el-button class="hollow_out mar_L_10" @click="search()" plain>搜索</el-button>
                </div>
                <span class="xcx-add left font14" @click="add()">新增文章</span>
            </div>
            <div class="xcx-content">
                ...
                <!--分页-->
                <div class="paging">
                    <el-pagination class="left" @current-change="handleCurrentChange" :page-size="limit" :current-page="page" background layout="prev, pager, next" :total="count"></el-pagination>
...
<script type="text/javascript" src="../../../static/js/banner/consulting.js"></script>

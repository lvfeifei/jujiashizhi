        ...
        <div class="content">
            <div class="xcx-head">
                <div style="display: flex">
                    <el-input class="font14" placeholder="关键字搜索" v-model="key" clearable></el-input>
                    <el-button class="hollow_out mar_L_10" @click="search()" plain>搜索</el-button>
                </div>
                <span class="xcx-add left font14" @click="add()">新增Banner</span>
            </div>
            <div class="xcx-content">
                <!--列表-->
                <el-table border :data="tableData" stripe style="width: 100%">
                    <el-table-column prop="picture" label="banner预览" width="200">
                        <div slot-scope="scope">
                            <img class="img_rectangle" :src="scope.row.picture" alt="">
                        </div>
                    </el-table-column>
                ...
                <!--分页-->
                <div class="paging">
                    <el-pagination class="left" @current-change="handleCurrentChange" :current-page="page" :page-size="limit" background layout="prev, pager, next" :total="count"></el-pagination>
...
<script type="text/javascript" src="../../../static/js/banner/swiper.js"></script>
